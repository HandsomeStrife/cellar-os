...
<h2>Plans</h2>
<p>Two plans, <strong>Pro</strong> and <strong>Group</strong>. Pro carries the whole day-to-day product for a single venue; Group adds trading across every venue in the group. The pricing page highlights your current plan and lists what each one includes. The full breakdown is in the <a href="{{ url('/guide/plans') }}" wire:navigate>Plan &amp; feature matrix</a>.</p>
