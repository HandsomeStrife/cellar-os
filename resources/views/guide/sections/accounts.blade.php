...
<p>New accounts start on the <strong>Pro</strong> plan. Sign in at <code>/login</code>; reset a forgotten password from the link on that page.</p>
...
<p>CellarOS has two tiers, <strong>Pro</strong> and <strong>Group</strong>. Pro covers everything a single venue needs; Group adds trading across multiple venues. The full breakdown is in the <a href="{{ url('/guide/plans') }}" wire:navigate>Plan &amp; feature matrix</a>.</p>
