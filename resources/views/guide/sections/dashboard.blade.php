...
<dl>
    <dt>Wines in catalogue</dt>
    <dd>How many distinct wines you trade.</dd>
    <dt>Bottles in stock</dt>
    <dd>Total received bottles across your venues, with the number of distinct labels.</dd>
    <dt>Inventory value</dt>
    <dd>Sum of quantity × last purchase price, in your base currency.</dd>
    <dt>Active suppliers</dt>
    <dd>Suppliers marked Active, with the total alongside.</dd>
</dl>
...
<div class="callout">
    Before you have any stock, the dashboard shows a <strong>getting-started</strong> checklist instead, linking to each setup step.
</div>
