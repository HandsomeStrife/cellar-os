...
<dl>
    <dt>Quantities</dt>
    <dd>Use the +/− steppers to adjust bottle counts. Low counts are flagged so they stand out.</dd>
    <dt>Archive &amp; restore</dt>
    <dd>Toggle between active and archived lines; archive wines you no longer stock (and restore them later). <strong>Pro</strong> feature.</dd>
    <dt>Attachments</dt>
